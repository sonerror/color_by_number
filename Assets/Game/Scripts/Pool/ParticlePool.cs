...
public static class ParticlePool
{
    ...
    class Pool
    {
        ...
        public void Play(Vector3 pos,Color startColor)
        {
    ...
    static public void Play(ParticleSystem prefab, Vector3 pos,Color startColor)
    {
#if UNITY_EDITOR
        if (prefab == null)
        {
        ...
        pools[prefab.GetInstanceID()].Play(pos, startColor);
    }

    static public void Play(ParticleType particleType, Vector3 pos,Color startColor)
    {
#if UNITY_EDITOR
        ...
        Play(shortcuts[particleType], pos,startColor);
    }
